...
<div class="min-h-screen bg-base-200 font-sans text-base-content">
  <header class="navbar sticky top-0 z-30 border-b border-base-300 bg-base-100/90 px-4 backdrop-blur-md">
    <div class="flex-1">
    ...
    <div class="flex-none gap-3">
      <div class="dropdown dropdown-end">
        ...
        >
          ...
          <li>
            <button onclick={handleLogout} class="text-error hover:bg-error/10 py-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
